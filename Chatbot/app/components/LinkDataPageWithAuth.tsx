...
import { LinkDataDashboard } from './LinkDataDashboard';

/**
 * Link Data page component with authentication wrapper
 * Handles auth state and delegates rendering to LinkDataDashboard
 */
export function LinkDataPage() {
  return (
    <AuthWrapper>
      {(user, loading) => {
        if (loading) {
        ...
        return <LinkDataDashboard user={user} />;
      }}
    </AuthWrapper>
  );
}
