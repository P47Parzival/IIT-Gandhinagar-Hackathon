...
export function ChatWelcome({
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-3 sm:px-6 py-4 sm:py-8 rounded-lg" style={{ backgroundColor: '#f8f8f8' }}>
      <div className="max-w-3xl w-full text-center">
        ...
        >
          Get <span className="animated-gradient px-1 font-medium italic tracking-tight">help</span>{' '}
        ...
        <div className="usecase-container px-2">
          ...
          <button
            onClick={() => onSendMessage('Balance sheet assurance: Show GL accounts with variance > 30%')}
            className="usecase-card justify-start"
          >
            <span>Balance Sheet Assurance</span>
            <svg
